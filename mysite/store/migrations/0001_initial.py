# Generated by Django 5.2.9 on 2025-12-19 10:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.ImageField(blank=True, null=True, upload_to='avtar')),
                ('user_role', models.CharField(choices=[('host', 'host'), ('guest', 'guest')], default='guest', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rule', models.CharField(choices=[('no_smoking', 'no_smoking'), ('pets_allowed', 'pets_allowed')], max_length=50)),
                ...
                ('amenity', models.ManyToManyField(to='store.amenity')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('pending', 'pending'), ('approved', 'approved'), ('rejected', 'rejected'), ('cancelled', 'cancelled')], max_length=25)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('property', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='property_image', to='store.property')),
            ],
        ),
        migrations.CreateModel(
            name='Review',
